...
@section('content')
<form action="{{route('user_update_avatar')}}" method="post" id="update-avatar" enctype="multipart/form-data">
    @csrf
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div style="display: flex">
                            <div class="text-center" style="position: relative;display: inline-block;margin: 0px auto;cursor: pointer;">
                        ...
                        <p class="text-muted text-center">{{__('Member')}}</p>
                    </div>
                </div>
            </div>
            <div class="col-md-5" style="margin-right: auto">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <form action="{{route('user_update_profile')}}" id="edit-user-form" method="post" enctype="multipart/form-data">
                        @csrf
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>{{__('User Name')}}</b> <a class="float-right">{{$data->user_name}}</a><input type="text" class="hidden" id="id" name="id" value="{{$data->id}}">
                                </li>
                                <li class="list-group-item">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <input type="password" class="input-edit-profile" id="password" name="password" placeholder="current password">
                                </li>
                                <li class="list-group-item">
                                    <input type="password" class="input-edit-profile new-password" name="new_password" placeholder="new password">
                                </li>
                            </ul>
